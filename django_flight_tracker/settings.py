"""
Django settings for django_flight_tracker project.
...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY',
                            'm1k_j8+qlm*nk!yp(cv(7w*ticx3s8!hs_*ctmb3ei%^y85j8i')  # different than production
...
ROOT_URLCONF = 'django_flight_tracker.urls'
...
WSGI_APPLICATION = 'django_flight_tracker.wsgi.application'
